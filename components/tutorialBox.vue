<template>
  <div class="tutorialBoxContainer sm:w-80 w-screen h-screen sm:h-5/6 sm:w-1/3">
    <div class="logoTutorialContainer mt-5 grid justify-items-center">
      <h1>Tutorial</h1>
    </div>
...
export default {
  methods: {
    changeTutorial() {
      this.$emit('setTutorialUnActive', false)
    },
  },
}
</script>
